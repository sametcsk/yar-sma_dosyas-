# Veri Bilimi Yarışma Projesi

Bu repository, yarışma için hazırladığımız modelleme ve tahmin süreçlerini içermektedir.

## Dosya Yapısı ve Veri Seti

Projede kullandığımız ana veri dosyaları şunlardır:
- train.csv: Eğitim verilerimiz.
- test_x.csv: Tahmin yapacağımız test verileri.
